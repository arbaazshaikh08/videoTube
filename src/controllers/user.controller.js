...
const registerUser = asyncHandler( async (req, res) => {
    ...
    .status(201)
    .json(
        new ApiResponse(200, createdUser, "User Register Succcesfully")
    )
...
//     // Example validation for new password
...
//     // Add your own validation logic here (e.g., min length, special characters)
//     return password.length >= 8; // Example: must be at least 8 characters
// }
...
//    return res
//    .status(200)
//    .json(new ApiResponse(200, user,"Acount detailes updated successfully"))
// })
